        ...
        <dl>
          ...
          <div
            className={`prediction-row ${
              isCancer ? "result-positive" : "result-negative"
            }`}
          >
            ...
            <dd className="prediction-value">
              {isCancer ? (
                <>
                  ...
                  <p className="mt-2">
                    Kết quả này chỉ mang tính tham khảo và không thay thế chẩn
                    đoán y tế chuyên nghiệp.
                  </p>
                </>
              ) : (
                <>
                  ...
                  <p className="mt-2">
                    Tuy nhiên, bạn nên kiểm tra sức khỏe định kỳ và liên hệ bác
                    sĩ nếu có triệu chứng bất thường.
                  </p>
                </>
              )}
            </dd>
